...
_MFM_SKETCHES:=demo-sketch mfm-sketch
...
my-sketch:	FORCE
	...
	exit 9 ; fi
	cp $(MY_SKETCH) $(_MFM_SKETCH_BUILD_DIR)/mySketch.cpp
...
.SECONDEXPANSION:
$(_MFM_SKETCHES):	$(_MFM_SKETCH_BUILD_DIR)/$$@.bin $$@-size
...
$(_MFM_SKETCH_BUILD_DIR)/%.elf:	$(_MFM_SKETCH_BUILD_DIR)/%.o zpu-core-library $(ISHW_CROSS_LD_SOURCES) $(ISHW_ALL_DEP)
